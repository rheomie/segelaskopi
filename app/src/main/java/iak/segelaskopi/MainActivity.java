...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    String[] list = {"Pohon Kopi", "Biji Kopi", "Roast Kopi", "Penggiling Kopi", "Air", "Segelas Kopi"};
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        switch (position) {
            ...
            case 2:
                ...
                i.putExtra("kotakDua", 100);//0 visible, 100 invisible, 200 gone
                i.putExtra("judDua", "");
                i.putExtra("ketDua", "");
                ...
                i.putExtra("kotakEmpat", 100);//0 visible, 100 invisible, 200 gone
                i.putExtra("judEmpat", "");
                i.putExtra("ketEmpat", "");
            ...
            case 5:
                ...
                textKetAtas = "Pembuatan segelas kopi disebut juga dengan <i>brewing/brew</i> dalam bahasa inggris, atau juga biasa disebut dengan menyeduh.<br/>" +
                        "Proses seduh kopi dapat dilakukan umumnya dengan dua cara, yaitu Manual atau dengan menggunakan Mesin kopi.<br/>" +
                        "Proses penyeduhan kopi, dilakukan umumnya dengan menggunakan Air panas yang gunanya adalah untuk mengekstraksi kandungan kimia pada kopi agar menjadi secangkir kopi yang siap untuk di nikmati.<br/>" +
                        "Tetapi ada juga cara lain yang dikenal dengan nama <i>Cold Brew</i> dan <i>Cold Drip</i>" +
                        "";
                i.putExtra("ketAtas", textKetAtas);
    ...
    public void tombolBuatKopi(View view) {
